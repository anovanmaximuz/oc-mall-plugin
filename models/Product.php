...
class Product extends Model
{
    ...
    public function filterFields($fields, $context = null)
    {
        ...
        $options = $this->getInventoryManagementMethodOptions();
        ...
        if (count($this->getGroupByPropertyIdOptions()) < 2) {
            $fields->inventory_management_method->value = 'single';
        }

        return $fields->inventory_management_method->options = $options;
    }
